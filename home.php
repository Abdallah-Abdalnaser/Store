    ...
    <div class="contaner">
      ...
      <div class="cards">
        <?php
          ...
          $sql="select * from categories where Type ='processor' limit 6";
  ...
  <section class="product">
    <div class="contaner">
      ...
      <div class="cards">
        <?php
          include 'conection.php';
          $sql="select * from categories where Type ='Matherboard' limit 6";
          $result2= mysqli_query($con,$sql);
          if($result2) {
            while ($row=mysqli_fetch_assoc($result2)) {
              $id=$row['Id'];
  ...
  <section class="product">
    <div class="contaner">
      ...
      <div class="cards">
        <?php
          include 'conection.php';
          $sql="select * from categories where Type ='Ram' limit 6";
          $result2= mysqli_query($con,$sql);
          if($result2) {
            while ($row=mysqli_fetch_assoc($result2)) {
              $id=$row['Id'];
  ...
  <section class="product">
    <div class="contaner">
      ...
      <div class="cards">
        <?php
          include 'conection.php';
          $sql="select * from categories where Type ='Graphic Card' limit 6";
          $result2= mysqli_query($con,$sql);
          if($result2) {
            while ($row=mysqli_fetch_assoc($result2)) {
              $id=$row['Id'];
